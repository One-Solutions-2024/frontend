            ...
            <div className="td-pb-span8 td-main-content" role="main">
                <div className="td-ss-main-content">
                    ...
                    <div className="td-page-content tagdiv-type">
                        ...
                        <p>Our website address is: https://onesolutions.onrender.com.</p>
                        ...
                        <h3 className="wp-block-heading">Cookies</h3>
                        ...
                        <h3 className="wp-block-heading">Embedded content from other websites</h3>
                        <p>Articles on this site may include embedded content (e.g. videos, images, articles, etc.). Embedded content from other websites behaves in the exact same way as if the visitor has visited the other website.</p>

                        <p>These websites may collect data about you, use cookies, embed additional third-party tracking, and monitor your interaction with that embedded content, including tracking your interaction with the embedded content if you have an account and are logged in to that website.</p>

                        <h3 className="wp-block-heading">Analytics</h3>
                        <p>To improve the user experience we collect some basic demographic information from Google Analytics tool & it would be private.</p>

                        <h2 className="wp-block-heading">Who we share your data with</h2>
                        <p>We strongly believe private data is sensitive, and it’s not to be shared.</p>
                        ...
                        <h2 className="wp-block-heading">Where we send your data</h2>
